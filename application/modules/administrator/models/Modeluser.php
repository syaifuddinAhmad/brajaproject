...
class Modeluser extends CI_Model
{
    ...
    var $table = 'users';
    var $column_order = array(null,'first_name','last_name','username','company','alamat','phone','email','created_on','last_login','tgl_register','jatuh_tempo','active',null); //set column field database for datatable orderable
